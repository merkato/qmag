...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="500000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{4be9b682-34ca-4775-a85c-b426b25ad5ca}">
      <rule scalemaxdenom="100000" filter="type in ('stream','ditch','drain')" key="{893b136e-7c07-4a51-b842-270e74c05eec}" symbol="0" scalemindenom="1000" label="strumienie i rowy"/>
      <rule scalemaxdenom="200000" filter="type in ('river','canal')" key="{80d3d5dd-c3a5-4c2c-88db-231a2ff6cd85}" symbol="1" scalemindenom="100000" label="rzeki i kanały"/>
      <rule scalemaxdenom="100000" filter="type in ('river','canal')" key="{74d6f146-4c16-4da8-a4f4-918c3fb77e59}" symbol="2" scalemindenom="50000" label="rzeki i kanały"/>
      <rule scalemaxdenom="50000" filter="type in ('river','canal')" key="{dd73f7d3-b1b4-453b-a24a-78ff395dde19}" symbol="3" scalemindenom="1000" label="rzeki i kanały"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="34,104,255,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="0,208,255,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <aliases>
    ...
    <alias field="tunnel" index="3" name=""/>
