...
<qgis version="2.18.3" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{8c581a94-dd24-4c23-98dc-f0f398bdecf2}">
      <rule scalemaxdenom="100000" filter=" &quot;ELEV&quot; %5 ='0' AND  &quot;ELEV&quot; %10 !='0'" key="{16511cf1-68e7-442b-af15-fabbefe656ed}" symbol="0" scalemindenom="1000" label="pozostałe warstwice"/>
      <rule filter=" &quot;ELEV&quot; %10 ='0'" key="{8404ad8e-504f-4275-82cb-d6ca411889ad}" symbol="1" label="cięcie co 10m"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="205,151,124,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{c96a84be-3b57-4764-bac7-311ec4646298}">
      <rule description="warstwice 10m" filter=" &quot;ELEV&quot; %10 ='0'" key="{4679d42f-9ff7-4764-b704-3a0ad9fd4b1d}">
        <settings>
          <text-style fontItalic="0" fontFamily="DejaVu Serif" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="205,151,124,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ELEV" namedStyle="Book" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <placement repeatDistanceUnit="1" placement="3" maxCurvedCharAngleIn="20" repeatDistance="300" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="5" yOffset="0" offsetType="0" placementFlags="9" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" quadOffset="4" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
          <rendering fontMinPixelSize="3" scaleMax="10000000" fontMaxPixelSize="10000" scaleMin="1" upsidedownLabels="0" limitNumLabels="0" obstacle="1" obstacleFactor="1" scaleVisibility="0" fontLimitPixelSize="0" mergeLines="0" obstacleType="0" labelPerPart="0" zIndex="0" maxNumLabels="2000" displayAll="0" minFeatureSize="20"/>
          <data-defined/>
        </settings>
      </rule>
    </rules>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="124"/>
    <property key="labeling/textColorG" value="151"/>
    <property key="labeling/textColorR" value="205"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="7340132">
    <columns>
